...
export default function Specialize() {
  ...
  useEffect(() => {
    ...
    sectionRefs.current = sectionRefs.current.slice(0, 4); // For your 4 sections
  ...
  // Fixed callback ref functions
  const addProgressBarRef = (el: HTMLDivElement | null, index: number): void => {
    progressBarsRef.current[index] = el;
  };

  const addSectionRef = (el: HTMLElement | null, index: number): void => {
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 pb-20">
          <div className="space-y-12">
            ...
            <section 
              ...
              className="specialize-section text-center"
            >
